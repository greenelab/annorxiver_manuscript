...
Time required for a preprint to be published can vary from preprint to preprint; however, studies have found that preprints with a single vesion take less time than preprints with multiple versions [@doi:10.2139/ssrn.3455146].
