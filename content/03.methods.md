...
This model was trained using scikit-learn's [@raw:scikit-learn] implementation with a random seed of 100, output of 50 principal components, and default settings for all other parameters.
