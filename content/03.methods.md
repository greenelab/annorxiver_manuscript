...
For each document, we used spaCy to lemmatize each token and then averaged every token present within the CBOW model as well as the individual document [@arxiv:1405.4053].
