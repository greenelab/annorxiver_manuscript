...
Because many tokens were unique to one set or the other and observed at low frequency, we used the union of the top 0.05% of the most frequently occuring tokens appearing across each corpora.
...
A high value of KL divergence implicates that two distributions differ as opposed to the alternative.
