...
The longest publication time within the "Preprints in Motion" subset was 195 days; however, our bioRxiv snapshot contains preprint-published pairs with publication times longer than this timepoint.
We performed a secondary analysis that accounts for these publication pairs.
We filtered our bioRxiv snapshot to only contain publication pairs with publication time of less than or equal to 195 days, then mimicked our previous time analysis that examined relationships between linguistic changes and the time to publication.
