...
We encountered a total of 72 withdrawn preprints within our snapshot and removed these preprints from our analysis.
After removal, we had 97,951 preprints for our downstream analyses.
...
All corpora contain words that occur in high frequency and are prevalent throughout all documents.
These words are referred to as stopwords within the natural language processing community.
Stopwords provide a small amount of helpful information and are often removed within text processing pipelines' preprocessing or postprocessing steps.
