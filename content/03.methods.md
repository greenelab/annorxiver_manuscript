...
We selected articles close to the query via Cosine distance in the embedding space.
...
We then projected a query article into the same space and returned journals closest to the query. 
