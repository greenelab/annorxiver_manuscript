...
Following our two approaches, we used the filtered PMC training set to train the neural network visualization model named SAUCIE [@doi:10.1101/2020.03.04.975177].
This model serves as a medium for clustering and visualizing papers within the  PMC corpus.
We trained this model with the following parameter settings: learning rate of 0.001, lambda_b of 0, lambda_c of 0.001, lambda_d of 0.001 and 2000 steps/iterations.
Lastly, we used the fully trained model to project individual bioRxiv preprints onto the generated landscape to orient users on where their preprint falls along the landscape.
