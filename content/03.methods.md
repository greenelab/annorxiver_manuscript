...
Once identified, we return the journals that published these articles.
We also return the articles that led to each journal being reported, as this approach allows for journals that frequently publish articles to engulf our results.
...
The only difference is that we filtered out preprint-publication pairs within our bioRxiv snapshot that had a publication time longer than the slowest publication pair in [@doi:10.1101/2021.02.20.432090].
