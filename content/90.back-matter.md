...
**B.** Both the full text and abstract only distance distributions are centered around the bottom left, signifying that our document matching approach can work with abstracts alone instead of using full text.
](https://raw.githubusercontent.com/danich1/annorxiver/33f92c67e09168544739378996277a88efc0edb9/biorxiv/article_distances/output/figures/abstract_only_figure.png){#fig:abstract_only_distance tag="S4" width="100%"}
