...
These results suggested that a primary driver of the variability within the language used in bioRxiv could be the divide between data science approaches and cell biology ones.
...
This supports the notion that bioRxiv contains an influx of neuroscience and bioinformatics related research results. 
...
Reinforcing PC1's dichotomous theme, we examined preprints that had the highest and lowest values within the systems biology category (Table {#tbl:five_pc1_table}).
Preprints with the highest five PC values [@doi:10.1101/197400;@doi:10.1101/825943;@doi:10.1101/769299;@doi:10.1101/107250] included software packages, machine learning analyses, and other computational biology manuscripts, while preprints with the lowest five PC values [@doi:10.1101/455048;@doi:10.1101/371922;@doi:10.1101/733162;@doi:10.1101/745943;@doi:10.1101/754572] were focused on cellular signaling and protein activity.
