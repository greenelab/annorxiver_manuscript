...
When removing special and single-character tokens, more figure-related terms appeared enriched for published articles, and more research-related articles appeared enriched for bioRxiv (Supplementary Figure {@fig:corpora_comparison_panels_pre_v_pub}).
