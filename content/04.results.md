...
![
Time required to change preprints based on peer review feedback is an average of 16 days.
...
](https://raw.githubusercontent.com/greenelab/annorxiver/70eb7f00e880fc3c2b6db00c50205612a9152a4d/biorxiv/publication_delay_experiment/output/article_distance_vs_publication_time.png){#fig:distance_publication_time}
...
The color bar on the right represents the density of each square-bin in this plot where more dense regions have a brighter color compared to their counterparts.
](https://raw.githubusercontent.com/greenelab/annorxiver/70eb7f00e880fc3c2b6db00c50205612a9152a4d/biorxiv/publication_delay_experiment/output/version_count_vs_publication_time.png){#fig:version_publication_time}

![
All preprint categories take at least 124 days to publish half of their total proportion of preprints.
...
](https://raw.githubusercontent.com/greenelab/annorxiver/70eb7f00e880fc3c2b6db00c50205612a9152a4d/biorxiv/time_to_publication/output/preprint_category_halflife.png){#fig:category_halflife}

The peer review pipeline can increase the amount of time required for a preprint to be published.
We sought to measure the amount of time required for a preprint to transition through the publication process.
We found that preprints  take ~16 days on average for authors to meet peer-reviewed demands (Figure {@#fig:distance_publication_time}).
We found that the average distance between preprints in the bioRxiv category was 5.068. 
This suggests that a single distance unit represents approximately 20% change of a preprint's textual content.
We found that it takes an average of ~51 days post a new version of a preprint onto bioRxiv (Figure {@fig:version_publication_time}).
Lastly, we found that the zoology and microbiology categories take the least amount of time to get their respective preprints published, while  scientific communication and education takes the most amount time (Figure {@fig:category_halflife}).
