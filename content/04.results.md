...
We also show that this trend holds when using abstract to generate document embeddings rather than full text (Supplemental Figure {@fig:abstract_only_distance}).
