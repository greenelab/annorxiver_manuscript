...
We also provide visual examples to reinforce this concept within Supplemental Tables {@tbl:top_five_pc1_table} and {@tbl:bottom_five_pc1_table}).
...
As with the first principal component we provide visual confirmation for the second principal component within Supplemental Tables {@tbl:top_five_pc2_table} and {@tbl:bottom_five_pc2_table}). 
More principal component word clouds can be found within our online repository (see Data Availability).
