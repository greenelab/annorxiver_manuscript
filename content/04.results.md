...
Following our global analysis, we performed principal component analysis on document emebddings generated by the bioRxiv corpus to inspect latent concepts captured within them.
Our analysis revealed that the strongest prinicpal component (PC) separated cell biology and informatics-related fields, while the second strongest component separated bioinformatics concepts from neuroscience concepts.
We explore these results further within our supplemental section (see 'Document embeddings derived from bioRxiv reveal fields and subfields' for more information).
