...
](https://raw.githubusercontent.com/danich1/annorxiver/5a593f0250886192650dd329e6968069b13e4fcb/figure_generation/output/figure_one_panels.png){#fig:corpora_comparison_panels width="100%"}
...
When adjusting for special and single length tokens  "" "" were enriched for PMCOA, while "et", "al" remained enriched for bioRxiv (Supplementary Figure {@fig:corpora_comparison_panels_pre_v_pub}).
