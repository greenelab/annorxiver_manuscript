...
This bargraph shows each model's accuracy as assessed through cross validation or an independent held out test set.
...
There are [HOW MANY] journals in our dataset, so the baseline performance of a classifier is quite low.
